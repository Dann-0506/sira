...
/**
 * DTO (Data Transfer Object) para el reporte de calificaciones finales.
 * Consolida el cálculo matemático con decisiones administrativas (Overrides).
 */
public class CalificacionFinal {
    ...
    private BigDecimal calificacionFinal; // Calificación oficial (Manual o Calculada)
